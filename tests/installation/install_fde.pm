...
sub run {
    ...
    assert_and_click 'fde_advanced_features';
    assert_screen 'fde_advanced_popup', 10;
    assert_and_click 'use_lvm';
    asssert_and_click 'encrypt_new_install';
    assert_and_click 'advanced_ok';
    #  full disk encryption
    assert_and_click 'next23_04';
